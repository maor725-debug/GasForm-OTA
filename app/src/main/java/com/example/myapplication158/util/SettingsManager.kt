...
class SettingsManager(context: Context) {
    ...
    var technicianLicenseExpiry: String
        get() = prefs.getString(KEY_TECHNICIAN_LICENSE_EXPIRY, "") ?: ""
        set(value) = prefs.edit().putString(KEY_TECHNICIAN_LICENSE_EXPIRY, value).apply()
